...
- 🧬 **Design mode:** constraint-based design of primers, barcodes, motifs/anchors, and spacers, with background screening and utilities (`background`, `merge`, `revcomp`, `lenstat`, `verify`, `final`).
