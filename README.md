...
- 🧪 **Degenerate mode:** compress ML-generated variant libraries into IUPAC-degenerate oligos for cost-efficient synthesis for selection-based assays (`compress`, `expand`).
