...
`Oligopool Calculator` facilitates the creative design and application of massively parallel reporter assays by automating and simplyfying the whole process. It has been benchmarked on synthetic libraries containing millions of defined variants. To learn more, read our paper published in ACS Synthetic Biology.
