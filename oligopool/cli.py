...
Space or comma-separated. Designed barcodes will avoid k-mers in ALL databases.''')
    opt.add_argument(
        '--random-seed',
        type=int,
        default=None,
...
Comma-separated motifs or a CSV path with an Exmotif column.''')
    opt.add_argument(
        ...
        metavar='\b',
        help='''>>[optional string(s)]
Path(s) to background k-mer database(s) generated by background().
Space or comma-separated. Designed primers will avoid k-mers in ALL databases.''')
    opt.add_argument(
        '--random-seed',
        type=int,
        default=None,
...
Comma-separated motifs or a CSV path with an Exmotif column.''')
    opt.add_argument(
        ...
        help='''>>[optional string(s)]
Path(s) to background k-mer database(s) created by the background command.
Space or comma-separated. Designed motifs will avoid k-mers in ALL databases.''')
    opt.add_argument(
        '--random-seed',
        type=int,
        default=None,
...
Comma-separated motifs or a CSV path with an Exmotif column.''')
    opt.add_argument(
        ...
        help='''>>[optional string(s)]
Path(s) to background k-mer database(s) created by the background command.
Space or comma-separated. Designed spacers will avoid k-mers in ALL databases.''')
    opt.add_argument(
        '--random-seed',
        type=int,
        default=None,
